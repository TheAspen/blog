...
Most of the time I have been working on new enemies for the game.
...
Nothing so special has happened during the last month. This is just very generic development work, day by day. The next big thing is
to test the custom Godot editor with Steam SDK and see if it is really working as expected. When I get this to work, I can focus more on the achievements. And maybe even add the highscore system into Steam?
