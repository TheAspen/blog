...
You can play it on Linux if you are not a Windows user.
...
Besides the combo system, I have mainly been focusing on testing and bug fixes. And if you are making a game yourself, preserve time for the testing and bug fixes!

These will take time, and you'll find a bunch more when you are testing. And take your time and have patience; testing the same thing over and over again will eat part of your soul. ;)
...
How this occurred was pretty obvious: special waves only spawn a fixed amount of enemies from pre-defined spawners. But for some reason, I got a random amount of enemies too from random spawners. And that messed up the enemy calculations, because there were more enemies than there should be.
