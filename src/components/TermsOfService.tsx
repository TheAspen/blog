      ...
      <Page background="main">
        ...
        <PageContent fill gap="small">
          <Content>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to The Aspen's
                  Devlog.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to The Aspen's Devlog,
                  accessible from{" "}
                  <a
                    href="www.theaspen.blog"
            ...
            <p>
              The Company and its original content (excluding content provided
              by You or other users), features and functionality are and will
              remain the exclusive property of the blog owner and its licensors.
              The Company is protected by copyright, trademark, and other laws
              of both the Country and foreign countries. The blog name, logo,
              and trade dress may not be used in connection with any product or
              service without the prior written consent of the blog owner.
            </p>
            <p>
              All blog posts, articles, images, graphics, design elements, and
              other content created by or for the blog owner ("Blog Content")
              are protected by intellectual property laws and are the exclusive
              property of the blog owner. You may not reproduce, distribute,
              modify, create derivative works of, publicly display, publicly
              perform, republish, download, store, transmit, sell, rent, or
              otherwise exploit any of the Blog Content without prior written
              consent.
            </p>
            <p>
              Nothing in these Terms and Conditions constitutes a transfer of
              any intellectual property rights from the blog owner to You. You
              agree that you will not take any action that may infringe upon or
              misappropriate the blog owner's intellectual property rights.
            </p>
            <p>
              Limited personal, non-commercial sharing of blog content through
              social media platforms is permitted, provided proper attribution
              is given to the original source and a link back to the original
              content is included.
            </p>
